# Interact with the program by adding contacts, removing contacts, displaying the contact list, adding contacts to favorites, and displaying favorite contacts.
